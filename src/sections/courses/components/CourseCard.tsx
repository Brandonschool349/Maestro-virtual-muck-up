...
export default function CourseCard({
  ...
  return (
    <Link href="#" className="group block h-full focus:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2">
      <Card variant="elevated" className="flex h-full flex-col overflow-hidden p-0 transition-all duration-200 ease-out group-hover:-translate-y-1 group-hover:shadow-lg">
